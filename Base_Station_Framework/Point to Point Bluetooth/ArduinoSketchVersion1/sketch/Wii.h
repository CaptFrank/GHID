...
public:
        ...
        /** Variable used to inidcate if a balance board is connected */
        bool balanceBoardConnected;
		bool valid_packet;
        /**@}*/
        ...
        int16_t topRight, topLeft, bottomRight, bottomLeft;
        /**@}*/
