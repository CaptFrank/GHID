 ...
 */
FIR_Filter::FIR_Filter(const float gain, const float* coefs){
 ...
 * @param gain						- The passband gain
 */
void FIR_Filter::set_gain(const float gain){
 ...
 */
void FIR_Filter::set_coefficients(const float *coefs){
 ...
 */
void FIR_Filter::set_coefficient(int idx, const float coef){
